...
/**
 * Parameter decorator that automatically creates and applies a search filter input for an entity. This is a
 * higher-level utility that can be used directly in a resolver.
 *
 ...
 */
export function SearchFilterArgs<T>(entityName: string, fields: string[]): ParameterDecorator {
