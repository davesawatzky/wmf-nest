...
import { Community, CommunityPayload } from '../entities/community.entity.js'
...
describe('Community E2E Tests', () => {
  ...
  describe('Community Queries', () => {
    it('Should enforce list authorization: admin succeeds, user fails', async () => {
      const results = await testWithBothRoles('list all communities', async (role) => {
    ...
    it('Should enforce list with registrations authorization: admin succeeds, user fails', async () => {
      const results = await testWithBothRoles('list communities with registrations', async (role) => {
        const response = (await createAuthenticatedRequest(role).query(gql`
    ...
    it('Should enforce list with community groups authorization: admin succeeds, user fails', async () => {
      const results = await testWithBothRoles('list communities with groups', async (role) => {
        const response = (await createAuthenticatedRequest(role).query(gql`
    ...
    it('Should find community by ID for both roles', async () => {
      const results = await testWithBothRoles('find community by ID', async (role) => {
    ...
    it('Should return error when community not found for both roles', async () => {
      const results = await testWithBothRoles('find non-existent community', async (role) => {
        const response = (await createAuthenticatedRequest(role).query(
          gql`
  ...
  describe('Community Mutations - Create', () => {
    ...
    it('Should create community with registrationID: both roles succeed', async () => {
      const results = await testWithBothRoles('create community', async (role) => {
    ...
    it('Should create community with communityInput: both roles succeed', async () => {
      const results = await testWithBothRoles('create community with input', async (role) => {
        const regId = role === 'admin' ? adminRegId : userRegId
  ...
  describe('Community Mutations - Update', () => {
    ...
    it('Should update community: both roles succeed', async () => {
      const results = await testWithBothRoles('update community', async (role) => {
        const response = (await createAuthenticatedRequest(role).mutate(
          gql`
    ...
    it('Should return userError for non-existent community: both roles', async () => {
      const results = await testWithBothRoles('update non-existent community', async (role) => {
        const response = (await createAuthenticatedRequest(role).mutate(
          gql`
            mutation CommunityUpdate($communityId: Int!, $communityInput: CommunityInput!) {
              communityUpdate(communityID: $communityId, communityInput: $communityInput) {
  ...
  describe('Community Mutations - Delete', () => {
    ...
    afterEach(async () => {
      ...
      await globalThis.prisma.tbl_reg_community
        .deleteMany({
          where: {
            OR: [{ id: deleteTestCommunityIds.admin }, { id: deleteTestCommunityIds.user }],
          },
        })
        .catch(() => {})
    ...
    it('Should delete community: both roles succeed', async () => {
      const results = await testWithBothRoles('delete community', async (role) => {
    ...
    it('Should return userError for non-existent community: both roles', async () => {
      const results = await testWithBothRoles('delete non-existent community', async (role) => {
        const response = (await createAuthenticatedRequest(role).mutate(
          gql`
            mutation CommunityDelete($communityId: Int!) {
              communityDelete(communityID: $communityId) {
