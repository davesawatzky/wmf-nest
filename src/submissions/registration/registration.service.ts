...
export class RegistrationService {
  ...
  async findAll(
    ...
    try {
      this.logger.log(`Fetching registrations with filters - userID: ${userID}, performerType: ${performerType}, teacherID: ${teacherID}`)
      ...
      this.logger.error(`Error fetching registrations with filters - userID: ${userID}, performerType: ${performerType}, teacherID: ${teacherID}`, error)
  ...
  async update(
    ...
    try {
      ...
      if (error.code === 'P2025') {
        ...
        this.logger.warn(`Registration update failed - Foreign key constraint violation for registration ${registrationID}`)
        return {
          userErrors: [{
