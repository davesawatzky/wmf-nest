...
export class RegistrationDataLoader {
  ...
  readonly userLoader = new DataLoader<number, tbl_user | null>(async (userIDs: readonly number[]) => {
  ...
  readonly groupLoader = new DataLoader<number, tbl_reg_group | null>(async (registrationIDs: readonly number[]) => {
  ...
  readonly teacherLoader = new DataLoader<number, tbl_user | null>(async (teacherIDs: readonly number[]) => {
  ...
  readonly schoolLoader = new DataLoader<number, tbl_reg_school | null>(async (registrationIDs: readonly number[]) => {
