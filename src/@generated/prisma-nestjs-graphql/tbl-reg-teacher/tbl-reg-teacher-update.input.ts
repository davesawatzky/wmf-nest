...
export class tbl_reg_teacherUpdateInput {
    ...
    @Field(() => tbl_registrationUpdateOneRequiredWithoutTbl_reg_teacherNestedInput, {nullable:true})
    @Type(() => tbl_registrationUpdateOneRequiredWithoutTbl_reg_teacherNestedInput)
