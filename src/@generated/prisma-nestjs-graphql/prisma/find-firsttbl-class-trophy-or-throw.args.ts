...
@ArgsType()
export class FindFirsttblClassTrophyOrThrowArgs {
    ...
    @Field(() => [Tbl_class_trophyScalarFieldEnum], {nullable:true})
    distinct?: Array<keyof typeof Tbl_class_trophyScalarFieldEnum>;
}
