...
@ArgsType()
export class FindFirsttblRegTeacherOrThrowArgs {
    ...
    @Field(() => [Tbl_reg_teacherScalarFieldEnum], {nullable:true})
    distinct?: Array<keyof typeof Tbl_reg_teacherScalarFieldEnum>;
}
