...
export class tbl_disciplineUncheckedCreateInput {
    ...
    @Field(() => tbl_subdisciplineUncheckedCreateNestedManyWithoutTbl_disciplineInput, {nullable:true})
    @Type(() => tbl_subdisciplineUncheckedCreateNestedManyWithoutTbl_disciplineInput)
