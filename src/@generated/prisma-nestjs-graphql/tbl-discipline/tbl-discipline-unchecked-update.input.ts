...
export class tbl_disciplineUncheckedUpdateInput {
    ...
    @Field(() => tbl_subdisciplineUncheckedUpdateManyWithoutTbl_disciplineNestedInput, {nullable:true})
    @Type(() => tbl_subdisciplineUncheckedUpdateManyWithoutTbl_disciplineNestedInput)
