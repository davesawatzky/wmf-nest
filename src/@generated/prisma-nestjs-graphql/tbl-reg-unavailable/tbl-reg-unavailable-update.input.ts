...
export class tbl_reg_unavailableUpdateInput {
    ...
    @Field(() => tbl_reg_groupUpdateOneRequiredWithoutTbl_reg_unavailableNestedInput, {nullable:true})
    @Type(() => tbl_reg_groupUpdateOneRequiredWithoutTbl_reg_unavailableNestedInput)
