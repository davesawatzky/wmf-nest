...
@InputType()
export class tbl_reg_unavailableUpdateManyWithoutTbl_reg_groupNestedInput {
  ...
  @Field(
    () => [tbl_reg_unavailableUpsertWithWhereUniqueWithoutTbl_reg_groupInput],
    { nullable: true },
  )
  ...
  @Field(
    () => [tbl_reg_unavailableUpdateWithWhereUniqueWithoutTbl_reg_groupInput],
    { nullable: true },
  )
  ...
  @Field(
    () => [tbl_reg_unavailableUpdateManyWithWhereWithoutTbl_reg_groupInput],
    { nullable: true },
  )
