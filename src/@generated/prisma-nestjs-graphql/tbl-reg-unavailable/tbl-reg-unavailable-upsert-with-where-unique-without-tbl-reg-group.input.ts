...
@InputType()
export class tbl_reg_unavailableUpsertWithWhereUniqueWithoutTbl_reg_groupInput {
  ...
  @Field(() => tbl_reg_unavailableUpdateWithoutTbl_reg_groupInput, {
    nullable: false,
  })
  @Type(() => tbl_reg_unavailableUpdateWithoutTbl_reg_groupInput)
  update!: tbl_reg_unavailableUpdateWithoutTbl_reg_groupInput
