...
@InputType()
export class tbl_reg_classesUpsertWithWhereUniqueWithoutTbl_registrationInput {
    ...
    @Field(() => tbl_reg_classesUpdateWithoutTbl_registrationInput, {nullable:false})
    @Type(() => tbl_reg_classesUpdateWithoutTbl_registrationInput)
    update!: tbl_reg_classesUpdateWithoutTbl_registrationInput;

    @Field(() => tbl_reg_classesCreateWithoutTbl_registrationInput, {nullable:false})
