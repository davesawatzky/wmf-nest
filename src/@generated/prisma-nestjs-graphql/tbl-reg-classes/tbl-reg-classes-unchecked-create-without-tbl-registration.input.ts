...
@InputType()
export class tbl_reg_classesUncheckedCreateWithoutTbl_registrationInput {
    ...
    @Field(() => tbl_reg_selectionUncheckedCreateNestedManyWithoutTbl_reg_classesInput, {nullable:true})
    @Type(() => tbl_reg_selectionUncheckedCreateNestedManyWithoutTbl_reg_classesInput)
