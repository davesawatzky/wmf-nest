...
@InputType()
export class tbl_reg_classesUncheckedUpdateManyWithoutTbl_registrationNestedInput {
    ...
    @Field(() => [tbl_reg_classesUpsertWithWhereUniqueWithoutTbl_registrationInput], {nullable:true})
    ...
    @Field(() => [tbl_reg_classesUpdateWithWhereUniqueWithoutTbl_registrationInput], {nullable:true})
    ...
    @Field(() => [tbl_reg_classesUpdateManyWithWhereWithoutTbl_registrationInput], {nullable:true})
