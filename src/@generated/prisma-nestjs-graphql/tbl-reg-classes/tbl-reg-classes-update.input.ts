...
import { tbl_reg_selectionUpdateManyWithoutTbl_reg_classesNestedInput } from '../tbl-reg-selection/tbl-reg-selection-update-many-without-tbl-reg-classes-nested.input';

@InputType()
export class tbl_reg_classesUpdateInput {
    ...
    @Field(() => tbl_registrationUpdateOneRequiredWithoutTbl_reg_classesNestedInput, {nullable:true})
    @Type(() => tbl_registrationUpdateOneRequiredWithoutTbl_reg_classesNestedInput)
    tbl_registration?: tbl_registrationUpdateOneRequiredWithoutTbl_reg_classesNestedInput;

    @Field(() => tbl_reg_selectionUpdateManyWithoutTbl_reg_classesNestedInput, {nullable:true})
    @Type(() => tbl_reg_selectionUpdateManyWithoutTbl_reg_classesNestedInput)
    tbl_reg_selection?: tbl_reg_selectionUpdateManyWithoutTbl_reg_classesNestedInput;
}
