...
export class tbl_reg_classesUpdateOneRequiredWithoutTbl_reg_selectionNestedInput {
    ...
    @Field(() => tbl_reg_classesCreateWithoutTbl_reg_selectionInput, {nullable:true})
    @Type(() => tbl_reg_classesCreateWithoutTbl_reg_selectionInput)
    create?: tbl_reg_classesCreateWithoutTbl_reg_selectionInput;

    @Field(() => tbl_reg_classesCreateOrConnectWithoutTbl_reg_selectionInput, {nullable:true})
    ...
    @Field(() => tbl_reg_classesUpsertWithoutTbl_reg_selectionInput, {nullable:true})
    ...
    @Field(() => tbl_reg_classesUpdateWithoutTbl_reg_selectionInput, {nullable:true})
