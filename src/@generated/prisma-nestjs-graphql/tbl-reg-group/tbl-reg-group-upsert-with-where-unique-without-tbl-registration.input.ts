...
@InputType()
export class tbl_reg_groupUpsertWithWhereUniqueWithoutTbl_registrationInput {

    @Field(() => tbl_reg_groupWhereUniqueInput, {nullable:false})
    @Type(() => tbl_reg_groupWhereUniqueInput)
    where!: tbl_reg_groupWhereUniqueInput;

    @Field(() => tbl_reg_groupUpdateWithoutTbl_registrationInput, {nullable:false})
    @Type(() => tbl_reg_groupUpdateWithoutTbl_registrationInput)
    update!: tbl_reg_groupUpdateWithoutTbl_registrationInput;

    @Field(() => tbl_reg_groupCreateWithoutTbl_registrationInput, {nullable:false})
