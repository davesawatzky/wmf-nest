...
@InputType()
export class tbl_reg_groupUpdateManyWithoutTbl_registrationNestedInput {

    @Field(() => [tbl_reg_groupCreateWithoutTbl_registrationInput], {nullable:true})
    @Type(() => tbl_reg_groupCreateWithoutTbl_registrationInput)
    create?: Array<tbl_reg_groupCreateWithoutTbl_registrationInput>;

    @Field(() => [tbl_reg_groupCreateOrConnectWithoutTbl_registrationInput], {nullable:true})
    ...
    @Field(() => [tbl_reg_groupUpsertWithWhereUniqueWithoutTbl_registrationInput], {nullable:true})
    ...
    @Field(() => tbl_reg_groupCreateManyTbl_registrationInputEnvelope, {nullable:true})
    ...
    @Field(() => [tbl_reg_groupUpdateWithWhereUniqueWithoutTbl_registrationInput], {nullable:true})
    ...
    @Field(() => [tbl_reg_groupUpdateManyWithWhereWithoutTbl_registrationInput], {nullable:true})
