...
@InputType()
export class tbl_reg_performerUncheckedUpdateManyWithoutTbl_registrationNestedInput {

    @Field(() => [tbl_reg_performerCreateWithoutTbl_registrationInput], {nullable:true})
    @Type(() => tbl_reg_performerCreateWithoutTbl_registrationInput)
    create?: Array<tbl_reg_performerCreateWithoutTbl_registrationInput>;

    @Field(() => [tbl_reg_performerCreateOrConnectWithoutTbl_registrationInput], {nullable:true})
    ...
    @Field(() => [tbl_reg_performerUpsertWithWhereUniqueWithoutTbl_registrationInput], {nullable:true})
    @Type(() => tbl_reg_performerUpsertWithWhereUniqueWithoutTbl_registrationInput)
    upsert?: Array<tbl_reg_performerUpsertWithWhereUniqueWithoutTbl_registrationInput>;

    @Field(() => tbl_reg_performerCreateManyTbl_registrationInputEnvelope, {nullable:true})
    ...
    @Field(() => [tbl_reg_performerUpdateWithWhereUniqueWithoutTbl_registrationInput], {nullable:true})
    @Type(() => tbl_reg_performerUpdateWithWhereUniqueWithoutTbl_registrationInput)
    update?: Array<tbl_reg_performerUpdateWithWhereUniqueWithoutTbl_registrationInput>;

    @Field(() => [tbl_reg_performerUpdateManyWithWhereWithoutTbl_registrationInput], {nullable:true})
