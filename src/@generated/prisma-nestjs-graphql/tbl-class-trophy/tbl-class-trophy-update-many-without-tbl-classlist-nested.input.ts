...
@InputType()
export class tbl_class_trophyUpdateManyWithoutTbl_classlistNestedInput {
  ...
  @Field(() => [tbl_class_trophyCreateOrConnectWithoutTbl_classlistInput], {
    nullable: true,
  })
  ...
  @Field(
    () => [tbl_class_trophyUpsertWithWhereUniqueWithoutTbl_classlistInput],
    { nullable: true },
  )
  ...
  @Field(() => tbl_class_trophyCreateManyTbl_classlistInputEnvelope, {
    nullable: true,
  })
  ...
  @Field(
    () => [tbl_class_trophyUpdateWithWhereUniqueWithoutTbl_classlistInput],
    { nullable: true },
  )
  ...
  @Field(() => [tbl_class_trophyUpdateManyWithWhereWithoutTbl_classlistInput], {
    nullable: true,
  })
