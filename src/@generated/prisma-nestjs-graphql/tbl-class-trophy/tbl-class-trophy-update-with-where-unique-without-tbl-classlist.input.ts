...
@InputType()
export class tbl_class_trophyUpdateWithWhereUniqueWithoutTbl_classlistInput {
  ...
  @Field(() => tbl_class_trophyUpdateWithoutTbl_classlistInput, {
    nullable: false,
  })
  @Type(() => tbl_class_trophyUpdateWithoutTbl_classlistInput)
  data!: tbl_class_trophyUpdateWithoutTbl_classlistInput
}
