...
@InputType()
export class tbl_class_trophyUncheckedUpdateManyWithoutTbl_trophyNestedInput {
    ...
    @Field(() => [tbl_class_trophyUpsertWithWhereUniqueWithoutTbl_trophyInput], {nullable:true})
    ...
    @Field(() => [tbl_class_trophyUpdateWithWhereUniqueWithoutTbl_trophyInput], {nullable:true})
    ...
    @Field(() => [tbl_class_trophyUpdateManyWithWhereWithoutTbl_trophyInput], {nullable:true})
