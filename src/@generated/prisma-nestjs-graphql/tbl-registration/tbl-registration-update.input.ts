...
import { tbl_reg_groupUpdateManyWithoutTbl_registrationNestedInput } from '../tbl-reg-group/tbl-reg-group-update-many-without-tbl-registration-nested.input'
...
@InputType()
export class tbl_registrationUpdateInput {
  ...
  @Field(() => tbl_userUpdateOneWithoutTbl_registrationNestedInput, {
    nullable: true,
  })
  @Type(() => tbl_userUpdateOneWithoutTbl_registrationNestedInput)
  tbl_user?: tbl_userUpdateOneWithoutTbl_registrationNestedInput

  @Field(() => tbl_reg_classesUpdateManyWithoutTbl_registrationNestedInput, {
    nullable: true,
  })
  ...
  @Field(() => tbl_reg_communityUpdateManyWithoutTbl_registrationNestedInput, {
    nullable: true,
  })
  ...
  @Field(() => tbl_reg_groupUpdateManyWithoutTbl_registrationNestedInput, {
    nullable: true,
  })
  @Type(() => tbl_reg_groupUpdateManyWithoutTbl_registrationNestedInput)
  tbl_reg_group?: tbl_reg_groupUpdateManyWithoutTbl_registrationNestedInput

  @Field(() => tbl_reg_performerUpdateManyWithoutTbl_registrationNestedInput, {
    nullable: true,
  })
  ...
  @Field(() => tbl_reg_schoolUpdateOneWithoutTbl_registrationNestedInput, {
    nullable: true,
  })
  ...
  @Field(() => tbl_reg_teacherUpdateOneWithoutTbl_registrationNestedInput, {
    nullable: true,
  })
