...
@InputType()
export class tbl_registrationUncheckedUpdateManyWithoutTbl_userNestedInput {
    ...
    @Field(() => [tbl_registrationUpsertWithWhereUniqueWithoutTbl_userInput], {nullable:true})
    ...
    @Field(() => [tbl_registrationUpdateWithWhereUniqueWithoutTbl_userInput], {nullable:true})
    ...
    @Field(() => [tbl_registrationUpdateManyWithWhereWithoutTbl_userInput], {nullable:true})
