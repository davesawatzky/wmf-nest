...
export class tbl_registrationUpdateOneRequiredWithoutTbl_reg_communityNestedInput {
    ...
    @Field(() => tbl_registrationCreateWithoutTbl_reg_communityInput, {nullable:true})
    @Type(() => tbl_registrationCreateWithoutTbl_reg_communityInput)
    create?: tbl_registrationCreateWithoutTbl_reg_communityInput;

    @Field(() => tbl_registrationCreateOrConnectWithoutTbl_reg_communityInput, {nullable:true})
    ...
    @Field(() => tbl_registrationUpsertWithoutTbl_reg_communityInput, {nullable:true})
    ...
    @Field(() => tbl_registrationUpdateWithoutTbl_reg_communityInput, {nullable:true})
