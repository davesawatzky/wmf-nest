...
export class tbl_registrationUncheckedCreateWithoutTbl_reg_performerInput {
    ...
    @Field(() => tbl_reg_teacherUncheckedCreateNestedOneWithoutTbl_registrationInput, {nullable:true})
    @Type(() => tbl_reg_teacherUncheckedCreateNestedOneWithoutTbl_registrationInput)
