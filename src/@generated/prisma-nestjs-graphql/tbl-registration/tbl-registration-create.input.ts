...
import { tbl_reg_communityCreateNestedManyWithoutTbl_registrationInput } from '../tbl-reg-community/tbl-reg-community-create-nested-many-without-tbl-registration.input';
...
@InputType()
export class tbl_registrationCreateInput {
    ...
    @Field(() => tbl_userCreateNestedOneWithoutTbl_registrationInput, {nullable:true})
    @Type(() => tbl_userCreateNestedOneWithoutTbl_registrationInput)
    tbl_user?: tbl_userCreateNestedOneWithoutTbl_registrationInput;

    @Field(() => tbl_reg_classesCreateNestedManyWithoutTbl_registrationInput, {nullable:true})
    ...
    @Field(() => tbl_reg_communityCreateNestedManyWithoutTbl_registrationInput, {nullable:true})
    @Type(() => tbl_reg_communityCreateNestedManyWithoutTbl_registrationInput)
    tbl_reg_community?: tbl_reg_communityCreateNestedManyWithoutTbl_registrationInput;

    @Field(() => tbl_reg_groupCreateNestedManyWithoutTbl_registrationInput, {nullable:true})
    ...
    @Field(() => tbl_reg_performerCreateNestedManyWithoutTbl_registrationInput, {nullable:true})
    ...
    @Field(() => tbl_reg_schoolCreateNestedOneWithoutTbl_registrationInput, {nullable:true})
    ...
    @Field(() => tbl_reg_teacherCreateNestedOneWithoutTbl_registrationInput, {nullable:true})
