...
import { tbl_reg_teacherUncheckedCreateNestedOneWithoutTbl_registrationInput } from '../tbl-reg-teacher/tbl-reg-teacher-unchecked-create-nested-one-without-tbl-registration.input'

@InputType()
export class tbl_registrationUncheckedCreateWithoutTbl_userInput {
  ...
  @Field(
    () => tbl_reg_classesUncheckedCreateNestedManyWithoutTbl_registrationInput,
    { nullable: true },
  )
  @Type(
    () => tbl_reg_classesUncheckedCreateNestedManyWithoutTbl_registrationInput,
  ...
  @Field(
    () =>
      tbl_reg_communityUncheckedCreateNestedManyWithoutTbl_registrationInput,
    { nullable: true },
  )
  @Type(
    () =>
  ...
  @Field(
    () => tbl_reg_groupUncheckedCreateNestedManyWithoutTbl_registrationInput,
    { nullable: true },
  )
  @Type(
    () => tbl_reg_groupUncheckedCreateNestedManyWithoutTbl_registrationInput,
  ...
  @Field(
    () =>
      tbl_reg_performerUncheckedCreateNestedManyWithoutTbl_registrationInput,
    { nullable: true },
  )
  @Type(
    () =>
  ...
  @Field(
    () => tbl_reg_schoolUncheckedCreateNestedOneWithoutTbl_registrationInput,
    { nullable: true },
  )
  @Type(
    () => tbl_reg_schoolUncheckedCreateNestedOneWithoutTbl_registrationInput,
  ...
  @Field(
    () => tbl_reg_teacherUncheckedCreateNestedOneWithoutTbl_registrationInput,
    { nullable: true },
  )
  @Type(
    () => tbl_reg_teacherUncheckedCreateNestedOneWithoutTbl_registrationInput,
  )
  tbl_reg_teacher?: tbl_reg_teacherUncheckedCreateNestedOneWithoutTbl_registrationInput
}
