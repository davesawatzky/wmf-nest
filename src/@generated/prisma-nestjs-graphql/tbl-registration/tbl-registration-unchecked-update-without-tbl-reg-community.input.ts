...
export class tbl_registrationUncheckedUpdateWithoutTbl_reg_communityInput {
    ...
    @Field(() => tbl_reg_classesUncheckedUpdateManyWithoutTbl_registrationNestedInput, {nullable:true})
    @Type(() => tbl_reg_classesUncheckedUpdateManyWithoutTbl_registrationNestedInput)
