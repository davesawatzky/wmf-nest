...
import { tbl_reg_classesUncheckedUpdateManyWithoutTbl_registrationNestedInput } from '../tbl-reg-classes/tbl-reg-classes-unchecked-update-many-without-tbl-registration-nested.input'
...
@InputType()
export class tbl_registrationUncheckedUpdateWithoutTbl_userInput {
  ...
  @Field(
    () => tbl_reg_classesUncheckedUpdateManyWithoutTbl_registrationNestedInput,
    { nullable: true },
  )
  @Type(
    () => tbl_reg_classesUncheckedUpdateManyWithoutTbl_registrationNestedInput,
  )
  tbl_reg_classes?: tbl_reg_classesUncheckedUpdateManyWithoutTbl_registrationNestedInput

  @Field(
    () =>
      tbl_reg_communityUncheckedUpdateManyWithoutTbl_registrationNestedInput,
    { nullable: true },
  )
  @Type(
    () =>
  ...
  @Field(
    () => tbl_reg_groupUncheckedUpdateManyWithoutTbl_registrationNestedInput,
    { nullable: true },
  )
  @Type(
    () => tbl_reg_groupUncheckedUpdateManyWithoutTbl_registrationNestedInput,
  ...
  @Field(
    () =>
      tbl_reg_performerUncheckedUpdateManyWithoutTbl_registrationNestedInput,
    { nullable: true },
  )
  @Type(
    () =>
  ...
  @Field(
    () => tbl_reg_schoolUncheckedUpdateOneWithoutTbl_registrationNestedInput,
    { nullable: true },
  )
  @Type(
    () => tbl_reg_schoolUncheckedUpdateOneWithoutTbl_registrationNestedInput,
  ...
  @Field(
    () => tbl_reg_teacherUncheckedUpdateOneWithoutTbl_registrationNestedInput,
    { nullable: true },
  )
  @Type(
    () => tbl_reg_teacherUncheckedUpdateOneWithoutTbl_registrationNestedInput,
