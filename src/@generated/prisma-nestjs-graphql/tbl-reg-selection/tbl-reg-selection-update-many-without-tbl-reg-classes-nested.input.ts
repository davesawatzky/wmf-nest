...
@InputType()
export class tbl_reg_selectionUpdateManyWithoutTbl_reg_classesNestedInput {
  ...
  @Field(
    () => [tbl_reg_selectionUpsertWithWhereUniqueWithoutTbl_reg_classesInput],
    { nullable: true },
  )
  ...
  @Field(
    () => [tbl_reg_selectionUpdateWithWhereUniqueWithoutTbl_reg_classesInput],
    { nullable: true },
  )
  ...
  @Field(
    () => [tbl_reg_selectionUpdateManyWithWhereWithoutTbl_reg_classesInput],
    { nullable: true },
  )
