...
export class tbl_reg_selectionUpdateInput {
    ...
    @Field(() => tbl_reg_classesUpdateOneRequiredWithoutTbl_reg_selectionNestedInput, {nullable:true})
    @Type(() => tbl_reg_classesUpdateOneRequiredWithoutTbl_reg_selectionNestedInput)
