...
@InputType()
export class tbl_classlistUncheckedCreateWithoutTbl_categoryInput {
    ...
    @Field(() => tbl_class_trophyUncheckedCreateNestedManyWithoutTbl_classlistInput, {nullable:true})
    @Type(() => tbl_class_trophyUncheckedCreateNestedManyWithoutTbl_classlistInput)
