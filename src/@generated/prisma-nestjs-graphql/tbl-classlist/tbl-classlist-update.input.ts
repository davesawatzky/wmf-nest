...
import { tbl_class_trophyUpdateManyWithoutTbl_classlistNestedInput } from '../tbl-class-trophy/tbl-class-trophy-update-many-without-tbl-classlist-nested.input';

@InputType()
export class tbl_classlistUpdateInput {
    ...
    @Field(() => tbl_categoryUpdateOneRequiredWithoutTbl_classlistNestedInput, {nullable:true})
    ...
    @Field(() => tbl_levelUpdateOneRequiredWithoutTbl_classlistNestedInput, {nullable:true})
    ...
    @Field(() => tbl_subdisciplineUpdateOneRequiredWithoutTbl_classlistNestedInput, {nullable:true})
    ...
    @Field(() => tbl_class_trophyUpdateManyWithoutTbl_classlistNestedInput, {nullable:true})
    @Type(() => tbl_class_trophyUpdateManyWithoutTbl_classlistNestedInput)
    tbl_class_trophy?: tbl_class_trophyUpdateManyWithoutTbl_classlistNestedInput;
}
