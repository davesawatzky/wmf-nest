...
@InputType()
export class tbl_classlistUncheckedUpdateManyWithoutTbl_subdisciplineNestedInput {
  ...
  @Field(
    () => [tbl_classlistUpsertWithWhereUniqueWithoutTbl_subdisciplineInput],
    { nullable: true },
  )
  ...
  @Field(
    () => [tbl_classlistUpdateWithWhereUniqueWithoutTbl_subdisciplineInput],
    { nullable: true },
  )
  ...
  @Field(
    () => [tbl_classlistUpdateManyWithWhereWithoutTbl_subdisciplineInput],
    { nullable: true },
  )
