...
@InputType()
export class tbl_classlistUpdateManyWithoutTbl_categoryNestedInput {
  ...
  @Field(() => [tbl_classlistUpsertWithWhereUniqueWithoutTbl_categoryInput], {
    nullable: true,
  })
  ...
  @Field(() => [tbl_classlistUpdateWithWhereUniqueWithoutTbl_categoryInput], {
    nullable: true,
  })
  ...
  @Field(() => [tbl_classlistUpdateManyWithWhereWithoutTbl_categoryInput], {
    nullable: true,
  })
