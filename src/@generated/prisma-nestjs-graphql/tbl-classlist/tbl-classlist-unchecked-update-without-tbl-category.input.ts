...
@InputType()
export class tbl_classlistUncheckedUpdateWithoutTbl_categoryInput {
    ...
    @Field(() => tbl_class_trophyUncheckedUpdateManyWithoutTbl_classlistNestedInput, {nullable:true})
    @Type(() => tbl_class_trophyUncheckedUpdateManyWithoutTbl_classlistNestedInput)
