...
@InputType()
export class tbl_classlistUpdateManyWithoutTbl_levelNestedInput {
    ...
    @Field(() => [tbl_classlistCreateOrConnectWithoutTbl_levelInput], {nullable:true})
    ...
    @Field(() => [tbl_classlistUpsertWithWhereUniqueWithoutTbl_levelInput], {nullable:true})
    ...
    @Field(() => tbl_classlistCreateManyTbl_levelInputEnvelope, {nullable:true})
    ...
    @Field(() => [tbl_classlistUpdateWithWhereUniqueWithoutTbl_levelInput], {nullable:true})
    ...
    @Field(() => [tbl_classlistUpdateManyWithWhereWithoutTbl_levelInput], {nullable:true})
