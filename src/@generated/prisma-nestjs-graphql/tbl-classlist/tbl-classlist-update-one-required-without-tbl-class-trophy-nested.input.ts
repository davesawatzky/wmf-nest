...
export class tbl_classlistUpdateOneRequiredWithoutTbl_class_trophyNestedInput {
    ...
    @Field(() => tbl_classlistCreateWithoutTbl_class_trophyInput, {nullable:true})
    @Type(() => tbl_classlistCreateWithoutTbl_class_trophyInput)
    create?: tbl_classlistCreateWithoutTbl_class_trophyInput;

    @Field(() => tbl_classlistCreateOrConnectWithoutTbl_class_trophyInput, {nullable:true})
    ...
    @Field(() => tbl_classlistUpsertWithoutTbl_class_trophyInput, {nullable:true})
    ...
    @Field(() => tbl_classlistUpdateWithoutTbl_class_trophyInput, {nullable:true})
