...
import { tbl_classlistCreateNestedManyWithoutTbl_subdisciplineInput } from '../tbl-classlist/tbl-classlist-create-nested-many-without-tbl-subdiscipline.input'

@InputType()
export class tbl_subdisciplineCreateInput {
  ...
  @Field(() => tbl_disciplineCreateNestedOneWithoutTbl_subdisciplineInput, {
    nullable: false,
  })
  ...
  @Field(() => tbl_classlistCreateNestedManyWithoutTbl_subdisciplineInput, {
    nullable: true,
  })
  @Type(() => tbl_classlistCreateNestedManyWithoutTbl_subdisciplineInput)
  tbl_classlist?: tbl_classlistCreateNestedManyWithoutTbl_subdisciplineInput
}
