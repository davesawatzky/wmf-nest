...
@InputType()
export class tbl_subdisciplineUpdateManyWithoutTbl_disciplineNestedInput {
  ...
  @Field(
    () => [tbl_subdisciplineUpsertWithWhereUniqueWithoutTbl_disciplineInput],
    { nullable: true },
  )
  ...
  @Field(
    () => [tbl_subdisciplineUpdateWithWhereUniqueWithoutTbl_disciplineInput],
    { nullable: true },
  )
  ...
  @Field(
    () => [tbl_subdisciplineUpdateManyWithWhereWithoutTbl_disciplineInput],
    { nullable: true },
  )
