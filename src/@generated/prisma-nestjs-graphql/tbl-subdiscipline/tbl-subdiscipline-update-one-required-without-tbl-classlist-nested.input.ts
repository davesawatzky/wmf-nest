...
export class tbl_subdisciplineUpdateOneRequiredWithoutTbl_classlistNestedInput {
    ...
    @Field(() => tbl_subdisciplineCreateWithoutTbl_classlistInput, {nullable:true})
    @Type(() => tbl_subdisciplineCreateWithoutTbl_classlistInput)
    create?: tbl_subdisciplineCreateWithoutTbl_classlistInput;

    @Field(() => tbl_subdisciplineCreateOrConnectWithoutTbl_classlistInput, {nullable:true})
    ...
    @Field(() => tbl_subdisciplineUpsertWithoutTbl_classlistInput, {nullable:true})
    ...
    @Field(() => tbl_subdisciplineUpdateWithoutTbl_classlistInput, {nullable:true})
