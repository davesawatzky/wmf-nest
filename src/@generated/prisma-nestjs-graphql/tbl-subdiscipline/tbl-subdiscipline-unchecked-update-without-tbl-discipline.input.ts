...
@InputType()
export class tbl_subdisciplineUncheckedUpdateWithoutTbl_disciplineInput {
    ...
    @Field(() => tbl_classlistUncheckedUpdateManyWithoutTbl_subdisciplineNestedInput, {nullable:true})
    @Type(() => tbl_classlistUncheckedUpdateManyWithoutTbl_subdisciplineNestedInput)
