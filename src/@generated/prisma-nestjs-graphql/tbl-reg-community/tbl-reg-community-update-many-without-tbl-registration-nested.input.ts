...
@InputType()
export class tbl_reg_communityUpdateManyWithoutTbl_registrationNestedInput {

    @Field(() => [tbl_reg_communityCreateWithoutTbl_registrationInput], {nullable:true})
    @Type(() => tbl_reg_communityCreateWithoutTbl_registrationInput)
    create?: Array<tbl_reg_communityCreateWithoutTbl_registrationInput>;

    @Field(() => [tbl_reg_communityCreateOrConnectWithoutTbl_registrationInput], {nullable:true})
    ...
    @Field(() => [tbl_reg_communityUpsertWithWhereUniqueWithoutTbl_registrationInput], {nullable:true})
    @Type(() => tbl_reg_communityUpsertWithWhereUniqueWithoutTbl_registrationInput)
    upsert?: Array<tbl_reg_communityUpsertWithWhereUniqueWithoutTbl_registrationInput>;

    @Field(() => tbl_reg_communityCreateManyTbl_registrationInputEnvelope, {nullable:true})
    ...
    @Field(() => [tbl_reg_communityUpdateWithWhereUniqueWithoutTbl_registrationInput], {nullable:true})
    @Type(() => tbl_reg_communityUpdateWithWhereUniqueWithoutTbl_registrationInput)
    update?: Array<tbl_reg_communityUpdateWithWhereUniqueWithoutTbl_registrationInput>;

    @Field(() => [tbl_reg_communityUpdateManyWithWhereWithoutTbl_registrationInput], {nullable:true})
