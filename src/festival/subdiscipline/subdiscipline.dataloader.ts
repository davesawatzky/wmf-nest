...
import type { tbl_category, tbl_discipline, tbl_level } from '@prisma/client'
...
export class SubdisciplineDataLoader {
  ...
  readonly categoriesLoader = new DataLoader<number, tbl_category[]>(async (subdisciplineIDs: readonly number[]) => {
  ...
  readonly levelsLoader = new DataLoader<number, tbl_level[]>(async (subdisciplineIDs: readonly number[]) => {
